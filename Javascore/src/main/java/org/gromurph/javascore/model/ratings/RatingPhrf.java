...
public class RatingPhrf extends RatingDouble
{
    ...
    public static final int MAX_RATING = -9999;
    ...
    @Override  public int getDecs() {return 0;}
...
//        return Math.round(secs) * 1000;
    ...
    @Override public void validateRace( Race race, Division div, WarningList warnings)
    {
        ...
        if (length <= 0)
        {
            warnings.add(
                MessageFormat.format(
                    res.getString( "WarningRaceNeedsLength"),
                    new Object[] { race.toString(), div.toString() }
                ));
        }
