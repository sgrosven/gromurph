...
* <b>Sample Usage</b> <p>
* <pre>
* import org.gromurph.util.swingworker.TimeoutException;
...
implements Runnable {
  ...
  public synchronized void start() {
      ...
      fIsStarted = true;  // sg add
      thread.start();
  }

  boolean fIsStarted = false; // sg add

  public boolean isStarted() // sg add
  {
      return fIsStarted;
  }
